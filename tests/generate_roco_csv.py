...
if __name__ == '__main__':
    ...
    python generate_roco_csv.py --dataset_dir "/mnt/g/Datasets/Body_Parts_XRay/Original/train" --input_text_name "captions.txt" --out_dir "../Body_Parts_XRay/" --out_csv_file "train.csv"
    python generate_roco_csv.py --dataset_dir "/mnt/g/Datasets/Body_Parts_XRay/Original/val/" --input_text_name "captions.txt" --out_dir "../Body_Parts_XRay/" --out_csv_file "val.csv"
    python generate_roco_csv.py --dataset_dir "/mnt/g/Datasets/Body_Parts_XRay/Original/test" --input_text_name "captions.txt" --out_dir "../Body_Parts_XRay/" --out_csv_file "test.csv"
    """
